...
<!-- 2nd line begins. -->
             ...
             <div class="Top_Menu">
               ...
               <nav >
                 ...
                 <button class="btn3"><a href="information.php" target="content_eng">Information</a></button>
                 <button class="btn3" onclick="window.location.href='#disqus_thread'">Comment</button>
                 <button class="btn3"><a href="othersites.php" target="content_eng">Other Sites</a></button>
               </nav>
...
<!-- 3rd line begins. -->
        ...
        <!-- 드롭 다운 메뉴 루틴 시작 -->
             ...
             <div class="Left_Menu">
                    ...
                    <iframe src="leftmenu_eng.php" name="leftmenu_eng" frameborder="no"
             ...
             <div class="Main">
                    ...
                    <iframe src="content_eng.php" name="content_eng" frameborder="no"
                    marginwidth="" marginheight="3" width="100%" height="100%" >
                    </iframe>
