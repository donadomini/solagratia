	...
	<ul>
     ...
     <li class='has-sub'><a href='#'><span>장로회제도</span></a>
           <ul>
             ...
             <li class='has-sub'><a href='#'><span>장로교회 정치제도</span></a>
             ...
             <li class='has-sub'><a href='#'><span>길레스피</span></a>

               <ul>

                 <?php

                 function list_Gillespie_ko() {
                   $list = scandir("./d_Gillespie_ko");
            ...
            <li class='has-sub'><a href='#'><span>사무엘 러더포드</span></a>

              <ul>

                <?php

                function list_Samuel_Rutherford_ko() {
                  $list = scandir("./d_Samuel_Rutherford_ko");
                  ...
                  $i = 0;
                    ...
                    while ($i < count($list)) {
                      if($list[$i] != '.') {
                        if($list[$i] != '..') {
                          $path[$i] ="./d_Samuel_Rutherford_ko/$list[$i]";
                          $list[$i] = basename($path[$i],".jpg");
